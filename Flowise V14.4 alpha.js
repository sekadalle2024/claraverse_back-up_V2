 ...
 * - NOUVEAU V14.3: Inclusion de la table déclencheuse dans l'envoi vers l'endpoint Flowise.
 */
(function () {
    "use strict";
  
    console.log(
      "🚀 Initialisation du script dynamique de tables V14.3 (Inclusion table déclencheuse)"
    );
  
    // --- CONFIGURATION CENTRALE ---
    const CONFIG = {
      FLOWISE_ENDPOINT_URL:
        "https://r534c2br.rpcld.co/api/v1/prediction/788fa323-02ed-4e6b-9322-973ac35bf736",
    ...
    function initialize() {
      ...
      console.log(
        "✅ Script V14.3 initialisé - CSS, affichage des tables, persistance des données et inclusion table déclencheuse"
      );
    }
    ...
    window.ClaraverseFlowiseV14_2 = {
      ...
      version: "14.3.0 - Inclusion table déclencheuse + Persistance des données",
    };
  })();